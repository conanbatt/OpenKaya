...
test "Korean Insei League: no supergroup allowed" do
  ...
  test_players << Player.new("Crystal", "127.0.0.3", "1d")
  test_players << Player.new("Jack", "127.0.0.3", "1d")
  test_players << Player.new("Christina", "127.0.0.4", "16k")
  test_players << Player.new("Louis", "127.0.0.4", "2k")
  test_players << Player.new("Jerome", "127.0.0.4", "3k")
  test_players << Player.new("Simon", "127.0.0.4", "5k")
  test_players << Player.new("Marie", "127.0.0.5", "8k")
  ...
  korean_insei_league.players << Player.new("Randalph", "127.0.0.4", "7k")
  korean_insei_league.players << Player.new("Summer", "127.0.0.5", "1k")
  korean_insei_league.players << Player.new("Sylvia", "127.0.0.7", "1d")
  highest_player = Player.new("Vincent", "127.0.0.6", "7d")
  korean_insei_league.players << highest_player
  
  korean_insei_league.start_period
  mock_league_results_based_on_rank(korean_insei_league)
  
  korean_insei_league.players << Player.new("Ron", "127.0.0.5", "12k")
  korean_insei_league.players << Player.new("Stephen", "127.0.0.6", "14k")
  korean_insei_league.players << Player.new("Steven", "127.0.0.7", "1k")
  lowest_player = Player.new("Carl", "127.0.0.4", "17k")
  korean_insei_league.players << lowest_player
  korean_insei_league.players << Player.new("Rocky", "127.0.0.4", "4k")
  korean_insei_league.players << Player.new("Daniel", "127.0.0.5", "5d")
  korean_insei_league.players << Player.new("Johny", "127.0.0.6", "4d")
  korean_insei_league.players << Player.new("Abhirup", "127.0.0.7", "1d")
  
  korean_insei_league.start_period
  mock_league_results_based_on_rank(korean_insei_league)
  
  korean_insei_league.players << Player.new("Ali", "127.0.0.4", "2k")
  korean_insei_league.players << Player.new("Manon", "127.0.0.5", "2d")
  korean_insei_league.players << Player.new("Cassandre", "127.0.0.6", "4k")
  korean_insei_league.players << Player.new("suzie", "127.0.0.7", "1k")
