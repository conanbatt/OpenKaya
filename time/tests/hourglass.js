...
test("Configure Timer", function() {
	...
	asyncTest("Black plays after 6 seconds", function() {
		setTimeout(function() {
			...
			test_remain[WHITE] = STARTING_TIME + 6;
	...
	asyncTest("White plays 10 seconds after black", function() {
		setTimeout(function() {
			board1.play();
			test_remain[BLACK] = STARTING_TIME - 6 + 10;
			test_remain[WHITE] = STARTING_TIME + 6 - 10;
	...
	asyncTest("Black plays after 12 seconds", function() {
		setTimeout(function() {
			board2.play();
			test_remain[BLACK] = STARTING_TIME - 6 + 10 - 12;
			test_remain[WHITE] = STARTING_TIME + 6 - 10 + 12;
	...
	// Play and test
	asyncTest("White tries to play 20 seconds after black, but he only had 18 seconds remaining.", function() {
		setTimeout(function() {
			board1.play();
			test_remain[BLACK] = STARTING_TIME - 6 + 10 - 12 + 18;
			test_remain[WHITE] = STARTING_TIME + 6 - 10 + 12 - 18;
